		...
		<!-- Home -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content">
					...
					<p>Bienvenido a <strong>Control Financiero</strong> un portal que te permite, de un modo sencillo y automático, registrar tus gastos e ingresos, monitorear inversiones, proyectar presupuestos o metas y mucho más !</p>
					<footer>
		...
		<!-- One -->
			<section id="one" class="main style2 right dark fullscreen">
				<div class="content box style2">
					...
					habituales, haciendo uso de los conocimientos académicos, los cuales tratamos de 
		...
		<!-- Two -->
			<section id="two" class="main style2 left dark fullscreen">
				<div class="content box style2">
					...
					Con esto, vas a tener toda tu información financiera en un solo lugar, lo que te va
			...
			<section id="work" class="main style3 primary">
				<div class="content">
					<header>
						...
						capacitación sobre diferentes activos financieros, así como también los pasos a 
